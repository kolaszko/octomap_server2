...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'ground_filter/plane_distance', default_value='0.07'),
        DeclareLaunchArgument('compress_map', default_value='True'),
        DeclareLaunchArgument('incremental_2D_projection',
                              default_value='False'),
        ...
        DeclareLaunchArgument('pointcloud_min_x', default_value='-30.0'),
        DeclareLaunchArgument('pointcloud_max_x', default_value='30.0'),
        DeclareLaunchArgument('pointcloud_min_y', default_value='-30.0'),
        DeclareLaunchArgument('pointcloud_max_y', default_value='30.0'),
        DeclareLaunchArgument('pointcloud_min_z', default_value='-10.0'),
        DeclareLaunchArgument('pointcloud_max_z', default_value='10.0'),
